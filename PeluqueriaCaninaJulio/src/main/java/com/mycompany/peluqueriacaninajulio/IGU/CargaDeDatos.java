...
public class CargaDeDatos extends javax.swing.JFrame {
   ...
   ControladorLogica control = null;
    ...
    private void initComponents() {
        ...
        btnGuardar1.setFont(new java.awt.Font("Georgia", 2, 18)); // NOI18N
        btnGuardar1.setText("ATRAS");
    ...
    control.crear(celDuenio, color, nomDuenio, nombre, observaciones, raza, alergico, atenEsp);
